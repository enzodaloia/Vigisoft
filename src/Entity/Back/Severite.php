...
#[ORM\Entity(repositoryClass: SeveriteRepository::class)]
class Severite
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
     ...
     */
    #[ORM\OneToMany(targetEntity: Tickets::class, mappedBy: 'severite')]
    ...
    public function removeTicket(Tickets $ticket): static
    {
        if ($this->tickets->removeElement($ticket)) {
            ...
            if ($ticket->getSeverite() === $this) {
                $ticket->setSeverite(null);
            }
        }
